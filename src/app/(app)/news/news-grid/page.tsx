...
export default function NewsGrid1() {
  return (
    <main>
      <article className="overflow-hidden w-full mb-[80px] md:mb-[120px] lg:mb-[160px] xl:mb-[210px] pt-[40px] pb-0 px-[60px] sm:pt-[60px] sm:pb-0 sm:px-[80px] lg:pt-[100px] lg:pb-0 lg:px-[120px] xl:pt-[150px] xl:pb-0 xl:px-[200px]">
        ...
        <div className="container mx-auto">
          <ul className="list-none p-0 grid grid-cols-1 md:grid-cols-3 gap-8">

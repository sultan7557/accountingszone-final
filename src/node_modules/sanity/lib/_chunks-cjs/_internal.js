...
const debug = debug__default.default("sanity:backup"), DEFAULT_DOWNLOAD_CONCURRENCY = 10, MAX_DOWNLOAD_CONCURRENCY = 24, helpText$B = `
Options
...
}, DEFAULT_LIST_BACKUP_LIMIT = 30, helpText$z = `
Options
...
const yellow = (str) => `\x1B[33m${str}\x1B[39m`, helpText$p = `
Options
...
`), examples = `Examples
  ...
  sanity deploy --schema-required`, helpText$o = `
Options
  --source-maps Enable source maps for built bundles (increases size of bundle)
  --auto-updates / --no-auto-updates Enable/disable auto updates of studio versions
  --no-minify Skip minifying built JavaScript (speeds up build, increases size of bundle)
...
}, defaultApiVersion = "v2022-06-01", helpText$i = `
...
const description$6 = "Downloads and validates all document specified in a workspace", helpText$h = `
Options
...
}, description$5 = "Extracts the studio configuration as one or more JSON manifest files.", helpText$c = `

...
function VisionGui(props) {
  ...
  }, [localStorage2]), handleKeyDown = useCallback((event) => {
  ...
  }, [params.valid, handleQueryExecution]), handlePaste = useCallback((evt_4) => {
  ...
  }, [perspectiveStack]), /* @__PURE__ */ jsxs(Root, { direction: "column", height: "fill", ref: visionRootRef, sizing: "border", overflow: "hidden", "data-testid": "vision-root", children: [

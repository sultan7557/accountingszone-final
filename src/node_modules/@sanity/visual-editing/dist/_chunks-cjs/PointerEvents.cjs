...
const PortalContainer = styledComponents.styled.div`
  height: 100%;
  inset: 0;
  overflow-y: scroll;
...
`, PopoverPortal = (props) => {
  ...
  let t0;
  $[0] !== onDismiss ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(PortalBackground, { onClickCapture: onDismiss }), $[0] = onDismiss, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== children || $[3] !== setBoundaryElement || $[4] !== t0 ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(_visualEditing.Portal, { children: /* @__PURE__ */ jsxRuntime.jsxs(PortalContainer, { "data-sanity-overlay-element": !0, ref: setBoundaryElement, onClick: handleClick, children: [
    t0,
    children

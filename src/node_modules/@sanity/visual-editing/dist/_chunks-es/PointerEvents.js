...
`, PopoverPortal = (props) => {
  ...
  let t0;
  $[0] !== onDismiss ? (t0 = /* @__PURE__ */ jsx(PortalBackground, { onClickCapture: onDismiss }), $[0] = onDismiss, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== children || $[3] !== setBoundaryElement || $[4] !== t0 ? (t1 = /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsxs(PortalContainer, { "data-sanity-overlay-element": !0, ref: setBoundaryElement, onClick: handleClick, children: [
    t0,
    children
